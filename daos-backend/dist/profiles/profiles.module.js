...
ProfileModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: profiles_schema_1.Profile.name, schema: profiles_schema_1.ProfileSchema }]),
        ],
        controllers: [profiles_controller_1.ProfilesController],
        providers: [profiles_service_1.ProfileService],
        exports: [profiles_service_1.ProfileService],
    })
], ProfileModule);
